...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _save() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Perfil atualizado!'), backgroundColor: AppTheme.success),
    );
                ...
                child: Stack(
                  children: [
                    CircleAvatar(
                      ...
                      child: Text(context.read<AuthProvider>().user?.initials ?? '?',
                          style: GoogleFonts.inter(fontSize: 36, fontWeight: FontWeight.bold, color: AppTheme.primaryGreen)),
                    ),
                    Positioned(
                      bottom: 0, right: 0,
                      child: Container(
