          ...
          Expanded(
            child: ListView(
              ...
              children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(auth.user?['name'] ?? 'Gerente', style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600)),
                ...
                Text('Notificações', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                  ...
                  child: Column(
                    children: [
                      ...
                      SwitchListTile(
                        ...
                        subtitle: const Text('Fechamento do dia'),
                        value: _dailySummary,
                        activeColor: AppTheme.primaryColor,
                ...
                const SizedBox(height: 16),
                Text('Conta', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                const SizedBox(height: 8),
                Card(
                  child: Column(
                    children: [
                      ...
                      const Divider(height: 1),
                      ListTile(
                        leading: const Icon(Icons.qr_code, color: AppTheme.textSecondary),
