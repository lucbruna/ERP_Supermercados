...
class ApiService {
  ...
  Future<void> setTokens(String token, String refreshToken) async {
    ...
    await _secureStorage.write(key: 'owner_jwt_token', value: token);
    await _secureStorage.write(key: 'owner_refresh_token', value: refreshToken);
  }

  Future<void> loadTokens() async {
    _token = await _secureStorage.read(key: 'owner_jwt_token');
    _refreshToken = await _secureStorage.read(key: 'owner_refresh_token');
  }

  Future<void> clearTokens() async {
    _token = null;
    _refreshToken = null;
    await _secureStorage.delete(key: 'owner_jwt_token');
    await _secureStorage.delete(key: 'owner_refresh_token');
  }
